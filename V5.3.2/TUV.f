...
* spectrum locator indices:
      ...
      integer i_user
      CHARACTER(len=32) :: arg_user
      REAL temp_user_in, height_user_in, zenith_user_in
...
* Open log file:
      CALL getarg(1, arg_user)
      READ(arg_user, *) temp_user_in
      CALL getarg(2, arg_user)
      READ(arg_user, *) height_user_in
      CALL getarg(3, arg_user)
      READ(arg_user, *) zenith_user_in
